...
uint8 simpleProfileChar1Props = GATT_PROP_NOTIFY;
...
uint8 simpleProfileChar1UserDesp[17] = "Characteristic 1\0";


// Simple Profile Characteristic 2 Properties
uint8 simpleProfileChar2Props = GATT_PROP_NOTIFY;
...
uint8 simpleProfileChar2UserDesp[17] = "Characteristic 2\0";


// Simple Profile Characteristic 3 Properties
uint8 simpleProfileChar3Props = GATT_PROP_NOTIFY;
...
uint8 simpleProfileChar3UserDesp[17] = "Characteristic 3\0";
...
uint8 simpleProfileChar4UserDesp[17] = "Characteristic 4\0";
  ...
  if ( pAttr->type.len == ATT_BT_UUID_SIZE )
  {
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR4_UUID:
        ...
        if(status == SUCCESS)
        {
          VOID osal_memcpy(pAttr->pValue, pValue, SIMPLEPROFILE_CHAR4_LEN);
