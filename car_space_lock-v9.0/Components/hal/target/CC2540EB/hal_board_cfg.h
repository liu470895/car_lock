...
/* 2 - Red */
#define LED2_BV                      BV(1)
#define LED2_SBIT                    P2_1
#define LED2_DDR                     P2DIR
#define LED2_POLARITY                ACTIVE_LOW

/* 3 - Yellow */
#define LED3_BV                      BV(2)
#define LED3_SBIT                    P2_2
...
#define BUZZER_SBIT                    P0_5
#define BUZZER_DDR                     P0DIR
#define BUZZER_POLARITY                ACTIVE_HIGH  

//batter 
#define BATTER_BV                      BV(5)
#define BATTER_SBIT                    P0_2
#define BATTER_DDR                     P0DIR
#define BATTER_POLARITY                ACTIVE_HIGH  
...
//#define MOTOR_BV                       BV(5)
//#define MOTOR_SBIT                     P0_5
//#define MOTOR_DDR                      P0DIR
//#define MOTOR_POLARITY                 ACTIVE_HIGH  
#define MOTORDIR_BV                    BV(1)
#define MOTORDIR_SBIT                  P1_1
#define MOTORDIR_DDR                   P1DIR
#define MOTORDIR_POLARITY              ACTIVE_HIGH  
...
/* LED's */
  ...
  #define HAL_TURN_OFF_LED5()       HAL_TURN_OFF_LED1()  /////////////////////////////////////////////////
  
  #define HAL_TURN_ON_LED1()        st( LED1_SBIT = LED1_POLARITY (1); )
  #define HAL_TURN_ON_LED2()        HAL_TURN_ON_LED1()
  #define HAL_TURN_ON_LED3()        HAL_TURN_ON_LED1()
  #define HAL_TURN_ON_LED4()        HAL_TURN_ON_LED1()
  #define HAL_TURN_ON_LED5()        HAL_TURN_ON_LED1()  /////////////////////////////////////////////////
  
  #define HAL_TOGGLE_LED1()         st( if (LED1_SBIT) { LED1_SBIT = 0; } else { LED1_SBIT = 1;} )
  #define HAL_TOGGLE_LED2()         HAL_TOGGLE_LED1()
  #define HAL_TOGGLE_LED3()         HAL_TOGGLE_LED1()
  #define HAL_TOGGLE_LED4()         HAL_TOGGLE_LED1()
  #define HAL_TOGGLE_LED5()         HAL_TOGGLE_LED1()  /////////////////////////////////////////////////////
  
  #define HAL_STATE_LED1()          (LED1_POLARITY (LED1_SBIT))
  #define HAL_STATE_LED2()          HAL_STATE_LED1()
  #define HAL_STATE_LED3()          HAL_STATE_LED1()
  #define HAL_STATE_LED4()          HAL_STATE_LED1()
  #define HAL_STATE_LED5()          HAL_STATE_LED1()  /////////////////////////////////////////////////////
#endif

//buzzer
#define HAL_BUZZER_ON()             st( BUZZER_SBIT = BUZZER_POLARITY (1); )  
#define HAL_BUZZER_OFF()            st( BUZZER_SBIT = BUZZER_POLARITY (0); )  

//batter
#define HAL_BATTER_ON()             st( BATTER_SBIT = BATTER_POLARITY (1); )
#define HAL_BATTER_OFF()            st( BATTER_SBIT = BATTER_POLARITY (0); )

//moter
#define HAL_MOTOR_ON()              st( MOTOR_SBIT = MOTOR_POLARITY (1); )
#define HAL_MOTOR_OFF()             st( MOTOR_SBIT = MOTOR_POLARITY (0); )
#define HAL_MOTOR_UP()              st( MOTORDIR_SBIT = MOTORDIR_POLARITY (1); )
#define HAL_MOTOR_DOWN()            st( MOTORDIR_SBIT = MOTORDIR_POLARITY (0); )
